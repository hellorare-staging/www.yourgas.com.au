    ...
    (function($) {
        $.fn.html5lightbox = function(options) {
            ...
            inst.options = $.extend({
                ...
                fadespeed: 400,
                jsfolder: jsFolder,
                skinsfoldername: "skins/darkness/",
            ...
            try {
                if (new ActiveXObject("ShockwaveFlash.ShockwaveFlash")) inst.options.flashInstalled = true } catch (e) {
            ...
            inst.createMarkup = function() {
                ...
                if (inst.options.titlestyle == "right" || inst.options.titlestyle == "left") { inst.$lightboxBox.css({ "background-color": inst.options.bgcolor });
                    ...
                    if (inst.options.nextElem >= 0) {
                        for (j = inst.options.curElem - 1; j >= 0; j--)
                            if (inst.matchGroup(curGroup,
                                    inst.elemArray[j][ELEM_GROUP])) { inst.options.prevElem = j;
                                break }
            ...
            inst.hideNavArrows = function() {
                ...
                } else { inst.$prev.addClass("html5-hide");
            ...
            inst.each(function() {
                var self = $(this);
                if (self.data("autoopen")) { setTimeout(function() { self.click() }, self.data("autoopendelay") ? self.data("autoopendelay") : 0);
                    return false } });
